...
Create a block with name `change_password` and code:
...
<?= open_form() ?>
  ...
  <a class="submit right clear-both" href="javascript:;" onclick="return $(this).getForm().sendRequest('on_updatePassword', {
